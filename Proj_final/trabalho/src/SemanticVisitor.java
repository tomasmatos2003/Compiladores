...
public class SemanticVisitor extends DimanaBaseVisitor<Boolean> {
   ...
   public Boolean visitWrite(DimanaParser.WriteContext ctx) {
      ...
      try {
         ...
         System.out.println("O número de caracteres não é inteiro!");
         return false;
      }
            ...
            if (!dimension_map.containsKey(depedant) && !type_dependant.contains("string")) {
               if (has_real) {
                  ...
                  if (type_dependant.contains("real")) {
                     ...
                     System.out.println(dimension_map.toString());
                     return true;
   ...
   public static ArrayList<Boolean> what_operation(String s) {
      ...
      if (hasAddition) {
         System.out.println("String contains addition operation.");
         res.add(true);
      } else {
         res.add(false);
      }
      ...
      if (hasSubtraction) {
         System.out.println("String contains subtraction operation.");
         res.add(true);
      } else {
         res.add(false);
      }
      ...
      if (hasMultiplication) {
         System.out.println("String contains multiplication operation.");
         res.add(true);
      } else {
         res.add(false);
      }
      ...
      if (hasDivision) {
         System.out.println("String contains division operation.");
         res.add(true);
      } else {
         res.add(false);
      }
   ...
   public Boolean visitVarInicialization(DimanaParser.VarInicializationContext ctx) {
      ...
      val_to_map.add(x);
      System.out.println(!variables.containsKey(z));
      if (!palavras_reservadas.contains(z)) {
         if (ctx.init() == null) {
            ...
            if ((x.contains("list"))) {
               ...
               System.out.println(dimension_map.get(x).get(0));
   ...
   public Boolean visitConditional(DimanaParser.ConditionalContext ctx) {
      ...
      if (expressao.contains("==") || expressao.contains("<") || expressao.contains(">") || expressao.contains(">=") || expressao.contains("<=")) {
         ...
         if (this.variables.containsKey(var1)) {
            ...
            if(type.equals("integer") || type.equals("real")){
               ...
               System.out.println("DIMENSAOOO1 "+ dimension1);
            }
         } else {
         ...
         if(dimension1.equals(dimension2)){
            ...
            ErrorHandling.printError(ctx, "ERRO SEMÂNTICO : Variáveis "+ var1+" e "+var2+" não têm a mesma dimensão!");
            return false;
         }
