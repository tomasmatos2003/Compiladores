...
public interface CalculatorVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitExprPositive(CalculatorParser.ExprPositiveContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExprNegate(CalculatorParser.ExprNegateContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExprAss(CalculatorParser.ExprAssContext ctx);
	/**
